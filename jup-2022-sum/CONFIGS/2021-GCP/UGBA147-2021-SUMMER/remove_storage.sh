...
kubectl --namespace=ugba147-2021-summer delete -f init_shared_nfs_pvc2.yaml
kubectl --namespace=ugba147-2021-summer delete -f init_shared_nfs_pv2.yaml


kubectl --namespace=ugba147-2021-summer delete -f init_shared_nfs_pvc.yaml
kubectl --namespace=ugba147-2021-summer delete -f init_shared_nfs_pv.yaml
